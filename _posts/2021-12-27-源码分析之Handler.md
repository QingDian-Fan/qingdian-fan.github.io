...
![source_02_01.webp](../images/source_02_01.webp)
...
![source_02_02.webp](../images/source_02_02.webp)
当满足`p！=null`且`when == 0 || when < p.when`为`true`时，就是以下这种情况：

![source_02_03.webp](../images/source_02_03.webp)
...
![source_02_04.webp](../images/source_02_04.webp)
以上两种都是在队头队尾添加的，再看一个从插入到队列中间的情况：

![source_02_05.webp](../images/source_02_05.webp)
**总结**
